...
$sql  = "SELECT id,recipename,recipeimage,ingredients,descriptiondish ,typeofdish,price FROM recipes";
...
<html lang="en">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            // Check if the type of dish is Filipino
            if (trim(strtolower($row['typeofdish'])) === 'filipino') {
                echo '
                <div class="card-food">
